...
| Metrika | Hodnota |
| --- | ---: |
| Java soubory v `src` | 203 |
| Neblank Java řádky v `src` | 46 139 |
| Java soubory v `tests` | 40 |
| Neblank Java řádky v `tests` | 5 962 |
| Automatické test suite entry pointy | 30 |
| Render módy | 9 |
...
### Referenční headless benchmark rendererů

| Renderer | Rozlišení | Passy × běhy | Min [ms] | Median [ms] | Mean [ms] | Max [ms] |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Raster / PHONG | 256x256 | 3 × 5 | 6.52 | 6.95 | 7.71 | 12.45 |
| Dithering | 256x256 | 3 × 5 | 12.42 | 12.65 | 14.78 | 28.46 |
| Temporal Noise | 256x256 | 3 × 5 | 3.32 | 3.44 | 3.61 | 5.56 |
| Hex Mosaic | 256x256 | 3 × 5 | 2.23 | 2.47 | 2.55 | 3.36 |
| Ray Tracing | 96x96 | 3 × 5 | 9.00 | 9.48 | 10.36 | 15.40 |
| Path Tracing | 96x96 | 3 × 5 | 7.98 | 8.50 | 9.53 | 16.61 |
...
xychart-beta
    ...
    line "Raster / PHONG" [25.48, 90.35, 226.88]
    line "Temporal Noise" [14.02, 44.46, 96.66]
    line "Ray Tracing" [247.42, 982.08, 2178.36]
    line "Path Tracing" [218.92, 934.81, 1962.84]
```

| Renderer | 640x360 median [ms] | 1280x720 median [ms] | 1920x1080 median [ms] | Poměr 1080p / 360p |
| --- | ---: | ---: | ---: | ---: |
| Raster / PHONG | 25.48 | 90.35 | 226.88 | 8.90× |
| Temporal Noise | 14.02 | 44.46 | 96.66 | 6.89× |
| Ray Tracing | 247.42 | 982.08 | 2178.36 | 8.80× |
| Path Tracing | 218.92 | 934.81 | 1962.84 | 8.97× |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| PNG still | 18.42 | 0.02 MB | 32.93 | 0.08 MB | 43.71 | 0.20 MB |
| JPG still | 13.82 | 0.01 MB | 11.80 | 0.02 MB | 23.17 | 0.04 MB |
| PNG sequence | 126.20 | 0.12 MB | 176.62 | 0.62 MB | 400.55 | 1.64 MB |
| GIF | 202.14 | 0.31 MB | 652.87 | 0.91 MB | 1436.04 | 1.87 MB |
| AVI MJPEG | 44.23 | 0.06 MB | 117.34 | 0.18 MB | 257.01 | 0.35 MB |
