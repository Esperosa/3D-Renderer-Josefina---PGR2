...
| Neblank Java řádky v `src` | 46 206 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Raster / PHONG | 256x256 | 3 × 5 | 6.47 | 7.12 | 8.35 | 15.63 |
| Dithering | 256x256 | 3 × 5 | 12.21 | 12.48 | 12.58 | 13.76 |
| Temporal Noise | 256x256 | 3 × 5 | 3.33 | 3.40 | 3.59 | 5.45 |
| Hex Mosaic | 256x256 | 3 × 5 | 2.24 | 2.36 | 2.69 | 4.60 |
| Ray Tracing | 96x96 | 3 × 5 | 9.00 | 9.48 | 9.48 | 11.64 |
| Path Tracing | 96x96 | 3 × 5 | 7.79 | 8.14 | 8.36 | 10.85 |
...
xychart-beta
    ...
    line "Raster / PHONG" [22.61, 88.81, 199.48]
    line "Temporal Noise" [10.51, 44.39, 100.10]
    line "Ray Tracing" [215.22, 904.38, 1989.61]
    line "Path Tracing" [212.90, 895.71, 1819.39]
```

| Renderer | 640x360 median [ms] | 1280x720 median [ms] | 1920x1080 median [ms] | Poměr 1080p / 360p |
| --- | ---: | ---: | ---: | ---: |
| Raster / PHONG | 22.61 | 88.81 | 199.48 | 8.82× |
| Temporal Noise | 10.51 | 44.39 | 100.10 | 9.53× |
| Ray Tracing | 215.22 | 904.38 | 1989.61 | 9.24× |
| Path Tracing | 212.90 | 895.71 | 1819.39 | 8.55× |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| PNG still | 21.54 | 0.02 MB | 24.07 | 0.08 MB | 53.52 | 0.20 MB |
| JPG still | 16.17 | 0.01 MB | 18.15 | 0.02 MB | 30.70 | 0.04 MB |
| PNG sequence | 122.01 | 0.12 MB | 170.33 | 0.62 MB | 391.40 | 1.64 MB |
| GIF | 161.65 | 0.31 MB | 689.80 | 0.91 MB | 1478.07 | 1.87 MB |
| AVI MJPEG | 42.75 | 0.06 MB | 107.29 | 0.18 MB | 246.14 | 0.35 MB |
