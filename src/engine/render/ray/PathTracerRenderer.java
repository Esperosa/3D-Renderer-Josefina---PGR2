...
public class PathTracerRenderer implements Renderer {
    ...
    static final class ReferencePathState {
        double ox, oy, oz;
        double dx, dy, dz;
        double throughputR;
        double throughputG;
        ...
        double radianceB;
        double causticCarry;
        boolean lastEventDelta;
        double lastBsdfPdf;
        double lastSurfacePx, lastSurfacePy, lastSurfacePz;
        boolean lastSurfaceValid;

        ReferencePathState reset(TraceContext ctx) {
            ox = ctx.rayOx;
            oy = ctx.rayOy;
            oz = ctx.rayOz;
            dx = ctx.rayDx;
            ...
            lastSurfacePy = 0.0;
            lastSurfacePz = 0.0;
            lastSurfaceValid = false;
            return this;
        }
    }

    static final class ReferenceSurfaceLobes {
        double viewX, viewY, viewZ;
        double metallic;
        double transmissionWeight;
        double specularRoughness;
        double specularAlpha;
        double specularAlphaSq;
        double specularEnergyComp;
        double conductorEta;
        double conductorKR, conductorKG, conductorKB;
        double clearcoatRoughness;
        double clearcoatAlpha;
        double clearcoatAlphaSq;
        double clearcoatF0;
        double diffuseR, diffuseG, diffuseB;
        double specularR, specularG, specularB;
        double sheenR, sheenG, sheenB;
        double diffuseBrdfR, diffuseBrdfG, diffuseBrdfB;
        double sheenBrdfR, sheenBrdfG, sheenBrdfB;
        double mediumTrR, mediumTrG, mediumTrB;
        double diffuseWeight;
        double specularWeight;
        double clearcoatWeight;
        double sheenWeight;
        double transmissionWeightRgb;
        double totalWeight;
    }

    private static final class PreviewPathMetrics {
        final LongAdder pathBounceNanos = new LongAdder();
        ...
        final LongAdder environmentLightingNanos = new LongAdder();
        final LongAdder emissiveLightingNanos = new LongAdder();
