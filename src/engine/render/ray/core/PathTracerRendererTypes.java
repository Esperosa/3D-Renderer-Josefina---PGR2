...
final class ReferencePathState {
    double ox, oy, oz;
    double dx, dy, dz;
    double throughputR;
    double throughputG;
    ...
    ReferencePathState reset(PathTracerRenderer.TraceContext ctx) {
        ox = ctx.rayOx;
        oy = ctx.rayOy;
        oz = ctx.rayOz;
        dx = ctx.rayDx;
...
final class ReferenceSurfaceLobes {
...
final class PreviewPathMetrics {
